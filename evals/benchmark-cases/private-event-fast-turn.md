...
- identify the exact event/show permit category before stating lead time
- provide offline and operational fallbacks for critical dependencies
...
- a performer price or availability is invented
- one permit lead time is applied to every event category
